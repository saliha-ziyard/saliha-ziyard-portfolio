...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative">
      ...
      <div ref={containerRef} className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,480px)_1fr]  gap-10 lg:gap-6 xl:gap-10 items-center">
          ...
          <div className="flex flex-col justify-center lg:pl-8 xl:pl-12">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground mb-8 leading-tight">
              Crafting digital
              <br />
              <span className="text-outline">experiences</span>
            </h2>

            <div className="space-y-6 text-muted-foreground text-base md:text-lg leading-relaxed max-w-3xl">
              <p>
